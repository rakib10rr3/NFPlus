...
public class PlayerActivity extends AppCompatActivity implements Player.EventListener, VideoRendererEventListener, AudioRendererEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.d(getIntent().getStringExtra("title"));
